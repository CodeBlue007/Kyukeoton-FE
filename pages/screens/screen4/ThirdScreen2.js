...
const ThirdScreen2 = ({ navigation }) => {
    ...
    const fetchInitialData = async () => {
        const data = await API.get(`/categories/7/questions?page=1`);
        setfullItems(data);
    ...
    return (
        <LinearGradient colors={['#00BC4B', '#9EE398']} style={Screen3Style.container}>
            ...
            <ProgressBar curNum={2} backGroundProp={'#00A542'} />
            <Modall isModalVisible={isModalVisible} setIsModalVisible={setIsModalVisible} correct={correct} next={"ThirdScreen3"} navigation={navigation} solution={solution} />
